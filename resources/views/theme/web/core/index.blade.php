...
@section('page_content')
    <div class="section-wrapper">
        @include('theme.web.core.section.section')
    </div>
@endsection

@section('js')
    <script src="{{asset('assets/themes/app/page/js/core.js')}}"></script>
    <script src="{{asset('assets/themes/app/page/js/user.js')}}"></script>
@endsection
